...
public class Notagrupo {
    ...
    public void Todos(ActionEvent actionEvent) {
        try (Connection connection = MySQLConnection.connectDB()) {
            ...
            String sql = "SELECT * FROM Reactivos WHERE (comunes = 1 OR privado = 0) OR grupo IN (SELECT nombre FROM Login)";
        ...
        try {
            ...
            try (Connection connection = MySQLConnection.connectDB()) {
                ...
                String query = "SELECT * FROM Reactivos " +
                        "WHERE notas LIKE ? AND (comunes = 1 OR privado = 0) OR grupo IN (SELECT nombre FROM Login)";
